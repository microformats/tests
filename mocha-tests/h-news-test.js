...
describe('Minimum properties (h-news parsing test)', function() {
   ...
   it("found.items[0].properties['entry'][0].properties['author'][0]", function(){
      assert.equal(found.items[0].properties["entry"][0].properties["author"][0].toString(), "Tantek");
   })
...
describe('Broken into properties (h-news parsing test)', function() {
