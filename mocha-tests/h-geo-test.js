...
describe('Simple Geo (h-geo parsing test)', function() {
...
describe('Simple Properties Geo (h-geo parsing test)', function() {
...
describe('Hidden Value-Title Properties Geo (h-geo parsing test)', function() {
