...
describe('Emails (hcard parsing test)', function() {
   var htmlFragment = "\n<p class=\"vcard\">\n    <span class=\"fn\">John Doe</span> \n    <ul>\n        <li><a class=\"email\" href=\"mailto:john@example.com\">notthis@example.com</a></li>\n        <li>\n            <span class=\"email\">\n                <span class=\"type\">internet</span> \n                <a class=\"value\" href=\"mailto:notthis@example.com\">john@example.com</a>\n            </span>\n        </li> \n        <li><a class=\"email\" href=\"mailto:john@example.com?subject=parser-test\">notthis@example.com</a></li>\n        <li class=\"email\">john@example.com</li>\n    </ul>\n</p>\n"
   var found = helper.parseHTML(htmlFragment,'http://example.com/')
   var expected = {"items":[{"type":["h-card"],"properties":{"name":["John Doe"],"email":["mailto:john@example.com","john@example.com","mailto:john@example.com?subject=parser-test","john@example.com"]}}]}
   ...
   it("found.items[0].properties['email'][1]", function(){
      assert.equal(found.items[0].properties["email"][1].toString(), "john@example.com");
   })
...
describe('Single occurrence properties (hcard parsing test)', function() {
   ...
   it("found.items[0].properties['bday'][0]", function(){
      assert.equal(found.items[0].properties["bday"][0].toString(), "2000-01-01T00:00:00-08:00");
   })
...
describe('Multiple occurrence properties (hcard parsing test)', function() {
   ...
   it("found.items[0].properties['agent'][0].value", function(){
      assert.equal(found.items[0].properties["agent"][0].value, "Jane Doe");
   })

   it("found.items[0].properties['agent'][0].type[0]", function(){
      assert.equal(found.items[0].properties["agent"][0].type[0].toString(), "h-card");
   })

   it("found.items[0].properties['agent'][0].properties['name'][0]", function(){
      assert.equal(found.items[0].properties["agent"][0].properties["name"][0].toString(), "Jane Doe");
   })
