  ...
  var fs          = require('fs'),
      ...
      urls = ['http://localhost:8889/h-adr.html',
              'http://localhost:8889/h-card.html',
              'http://localhost:8889/h-event.html',
              'http://localhost:8889/h-entry.html',
              'http://localhost:8889/h-geo.html',
              'http://localhost:8889/h-news.html',
              'http://localhost:8889/h-org.html',
              'http://localhost:8889/h-product.html',
              'http://localhost:8889/h-recipe.html',
              'http://localhost:8889/h-resume.html',
              'http://localhost:8889/h-review-aggregate.html',
              'http://localhost:8889/h-review.html',
              'http://localhost:8889/rel.html',
              'http://localhost:8889/url.html',
              'http://localhost:8889/includes.html',

              'http://localhost:8889/adr.html',
              'http://localhost:8889/geo.html',
              'http://localhost:8889/hcalendar.html',
              'http://localhost:8889/hcard.html',
              'http://localhost:8889/hnews.html',
              'http://localhost:8889/hproduct.html',
              'http://localhost:8889/hentry.html',
              'http://localhost:8889/hresume.html',
              'http://localhost:8889/hreview-aggregate.html',
              'http://localhost:8889/hreview.html',
              'http://localhost:8889/mixed-versions.html']
